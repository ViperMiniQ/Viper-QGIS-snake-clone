...
class viper:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Viper (QGIS snake clone)')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('viper', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Viper (QGIS snake clone)'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Viper (QGIS snake clone)'),
                action)
